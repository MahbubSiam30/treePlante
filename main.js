...
hanburger.addEventListener("click", () => {
    ...
    hanburger.classList.toggle('ri-close-large-line')
})
...
sr.reveal('.service__data, .popular__card', {interval: 100})
...
sr.reveal('.review__leaf, .footer__floral', {delay: 100, origin: "left"})
